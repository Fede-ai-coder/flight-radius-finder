...
import { DEPARTURE_SUGGESTIONS, findDepartureCenter } from "@/lib/departureSearch";
          ...
          <div className="mb-3">
            ...
            <input
              ...
              onChange={(e) => {
                ...
                const coords = findDepartureCenter(query);
            ...
            <datalist id="departure-cities">
              {Array.from(new Set(DEPARTURE_SUGGESTIONS)).map((item) => (
