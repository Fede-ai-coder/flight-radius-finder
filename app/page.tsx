...
export default function HomePage() {
  ...
  const currentSearchSignature = useMemo(() => JSON.stringify({ origins: nearbyOriginCodes, destinations: destinationCodes, date, adults, maxResults, nonStop, arrivalRadiusKm }), [nearbyOriginCodes, destinationCodes, date, adults, maxResults, nonStop, arrivalRadiusKm]);
